...
public class Record2 extends javax.swing.JFrame {
    ...
    private void dataTableTeacherMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_dataTableTeacherMouseClicked
            ...
            String sql = "select * from pilot where PilotID='"+tableClick+"'";
            pst = con.prepareStatement(sql);
            rs = pst.executeQuery();
            if(rs.next()){
                this.hide();
                PilotDetails teacher=new PilotDetails();
                teacher.setVisible(true);
                String add1 = rs.getString("PilotID");
                ...
                teacher.aadharField.setText(add7);
